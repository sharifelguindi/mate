...
MIGRATION_MODULES = {"sites": "mate.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "mate.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""Sharif Elguindi""", "sharif-elguindi@mate.consensusai.com")]
...
# https://docs.allauth.org/en/latest/account/configuration.html
# Email verification disabled for medical SaaS with controlled user management
ACCOUNT_EMAIL_VERIFICATION = "none"
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "mate.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "mate.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "mate.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "mate.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "mate API",
    "DESCRIPTION": "Documentation of API endpoints of mate",
    "VERSION": "1.0.0",
...
DJANGO_VITE = {
    "default": {
        ...
        "static_url_prefix": "vite",  # Prefix to match the vite output directory
